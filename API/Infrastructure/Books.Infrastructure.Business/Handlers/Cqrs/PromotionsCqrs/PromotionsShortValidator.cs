...
{
    public class PromotionsShortValidator : AbstractValidator<PromotionsShortQuery>
    {
        private readonly ILanguagesRepository _languagesRepository;
        public PromotionsShortValidator(ILanguagesRepository languagesRepository)
        {
        ...
        private async Task<bool> ValidatePromorions(PromotionsShortQuery query, ValidationContext<PromotionsShortQuery> context,
